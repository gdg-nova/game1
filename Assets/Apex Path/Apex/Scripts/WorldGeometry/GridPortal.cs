...
using UnityEngine;
    ...
    public sealed class GridPortal
    {
        ...
        public static GridPortal Create(string name, PortalType type, Bounds portalOne, Bounds portalTwo, AttributeMask exclusiveTo, IPortalAction action)
        {
            ...
            p.Initialize(name, type, portalOne, portalTwo, exclusiveTo, action);
        ...
        private void Initialize(string name, PortalType type, Bounds portalOne, Bounds portalTwo, AttributeMask exclusiveTo, IPortalAction action)
        {
            _type = type;
