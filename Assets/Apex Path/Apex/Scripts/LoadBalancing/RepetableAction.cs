...
namespace Apex.LoadBalancing
{
    ...
    /// </summary>
    public class RepetableAction : ILoadBalanced
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepetableAction"/> class. The action will repeat as long as <paramref name="action"/> returns <c>true</c>.
        /// </summary>
        ...
        public RepetableAction(Func<float, bool> action)
            : this(action, -1)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RepetableAction"/> class.
        /// </summary>
        /// <param name="action">The action to execute. The action will receive the time since it was queued as an argument, and should return whether to continue to repeat or not.</param>
        /// <param name="repetitions">The number of times to repeat this action provided the action itself returns <c>true</c></param>
        public RepetableAction(Func<float, bool> action, int repetitions)
        {
